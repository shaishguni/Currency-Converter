...
class CurrencyConverter:  # Create class
    def __init__(self):  # Special method in Python class
        ...
        window.title(" Shaish Currency Converter")  # Add title to application window
        window.configure(bg="grey")   # Add background color to application window
        ...
        lblConvertedAmount =Label(window,font="Helvetica 12 bold",bg="white", textvariable = self.convertedAmountVar).grid(row=3,column=2,sticky = E)
